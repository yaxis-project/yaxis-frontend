			...
			<Row gutter={[8, 8]}>
				<Col xs={24} sm={16}>
					<Row gutter={4}>
						...
						<Col flex="auto">
							<Title text={name} loading={loading} />
						...
						<>
							<Row align={'middle'} justify={'space-between'}>
								...
								<Row align={'middle'} justify={'space-between'}>
									...
									<Value inline value={metaVaultData.tvl} />
								</Row>
							</Row>
							<Row align={'middle'} justify={'space-between'}>
								<BalanceTitle>
									...
									title={
										<div>
											...
											<div>
												{'CurveLP: '}
												<b>
													{lpApyPercent?.toFixed(1)}%
												</b>
											</div>
											<div>
												{'CRV (80%): '}
												<b>
													{threeCrvApyPercent?.toFixed(
														1,
													)}
													%
												</b>
