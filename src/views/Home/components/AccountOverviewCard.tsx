    ...
    <Row gutter={16}>
      ...
      <Col span={14}>
        <Row style={{ display: 'flex', alignItems: 'center' }}>
          <StyledTitle style={{ margin: 0 }}>{mainTitle}</StyledTitle>
      ...
      <Col span={8}>
        <Row>
          <Text style={{ marginLeft: "auto" }} type="secondary">{time}</Text>
        </Row>
        <Row>
          <Title style={{ margin: 0, marginLeft: "auto", fontSize: '22px' }} level={5}>{value}</Title>
        </Row>
      </Col>
    </Row>
  </StyledCard>
