...
const RecentTransactionRow = (props: RecentTransactionRowProps) => {
  ...
  return (<Card.Grid hoverable={false} style={gridStyle}>
    <img
      src={transactionImg}
      height="32" style={{ marginTop: 4, position: 'absolute' }}
      alt="logo"
    />
    <Title style={{ margin: 0, marginLeft: "48px" }} level={5}>{main}</Title>
    <Text style={{ margin: 0, marginLeft: "48px", display: "block" }} type="secondary">{secondary}</Text>
  </Card.Grid>);
}
