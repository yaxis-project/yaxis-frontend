...
const StyledValue = styled.div<{inline?: boolean, fontSize?: string, secondary?: boolean}>`
  color: ${(props) => (props.secondary ? props.theme.color.secondary.grey : props.theme.color.black)};
