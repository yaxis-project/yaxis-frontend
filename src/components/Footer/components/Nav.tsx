...
const menu = (
  <Menu>
    <Menu.Item>
      <a target="_blank" rel="noopener noreferrer" href="https://etherscan.io/address/0xc330e7e73717cd13fb6ba068ee871584cf8a194f#code">
        yAxis Chef
      </a>
    </Menu.Item>
  </Menu>
...
const Nav: React.FC = () => {
  return (<StyledRow>
        ...
        <Col span={12} style={{textAlign: 'right'}}>
            ...
            <StyledLink target="_blank" href="https://twitter.com/yaxis_project">
