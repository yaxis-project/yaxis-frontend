...
const mainnet: AvalancheConfig = {
	...
	vaults: {
		...
		tricrypto: {
			...
			vault: '0xd00605E0551D49dbA83B9b026901fb3A55E7c692',
			vaultToken: 'CV:ATRICRYPTO',
			vaultTokenContract: '0x62B1c422075ac10d2b4349797c0180C9ADD1611c',
			gauge: '0x1B4e5C640F5565c57DE9f52c0bC304Ea54af4a6d',
		},
		// avax: {
