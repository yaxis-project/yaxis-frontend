...
export const traderjoeLPCurrencies = <const>['joewavax', 'wethavax']
...
export const TraderJoeLPContracts = <const>['joewavax', 'wethavax']
...
export const Vaults = <const>['av3crv', 'atricrypto', 'avax', 'joewavax', 'wethavax']
